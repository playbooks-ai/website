...
export default function Navigation({ activeSection }: NavigationProps) {
    ...
    return (
        <nav
            ref={navRef}
            style={{ opacity }}
            className="hidden md:flex fixed left-0 top-0 h-full w-20 z-50 backdrop-blur-xl bg-white/90 border-r border-gray-100 flex-col items-center py-6 transition-opacity duration-500 ease-out"
        >
            {/* Logo */}
            <a
