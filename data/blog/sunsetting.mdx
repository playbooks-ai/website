...
Playbooks has been largely a solo project, but it didn't happen in isolation. Thank you to [Adam Kaplan](https://github.com/adamkaplan) for filing issues, reporting bugs around GCP Vertex AI support, pytest upgrades, and token limit handling that made the project better. Thank you to everyone who forked the repo and explored the ideas in their own directions: [0xSojalSec](https://github.com/0xSojalSec), [AICraftWorksOrg](https://github.com/AICraftWorksOrg), [clikry](https://github.com/clikry), [felipetruman](https://github.com/felipetruman), [gabiz](https://github.com/gabiz), [iflow-mcp](https://github.com/iflow-mcp), [klin3867-crypto](https://github.com/klin3867-crypto), [lytv](https://github.com/lytv), [mohamedrayenbouzaabia-axelites](https://github.com/mohamedrayenbouzaabia-axelites), [Promptgrammer](https://github.com/Promptgrammer), [rushidesai1](https://github.com/rushidesai1), and [tiktaalik-ai](https://github.com/tiktaalik-ai).

And to all 79 people who starred the repo: you kept me going. An open-source research project with no corporate backing lives on attention and curiosity, and you provided both.
