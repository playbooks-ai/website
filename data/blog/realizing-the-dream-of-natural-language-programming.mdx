...
In early 2023, Andrej Karpathy tweeted: 
...
The story begins earlier - in August 2022, before the tweet, before ChatGPT changed everything. Working with GPT-3.5 Instruct (then state-of-the-art), we faced a concrete problem: building customer support AI agents that needed prescribed behavior *and* human-like flexibility.

The predominant approaches were (and still are!) -
...
But try specifying nuanced agent behaviors - handling corner cases, locale-specific variations, graceful degradation, intent switching and return, side quests. It's impossible to do with any of these approaches.
