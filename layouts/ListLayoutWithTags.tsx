        ...
        <div className="pt-12 mt-12 border-t border-gray-200">
            <nav className="flex justify-between items-center">
                {prevPage ? (
                    ...
                    <div className="text-lg font-light text-gray-300">← Previous</div>
                )}
                ...
                {nextPage ? (
                    ...
                    <div className="text-lg font-light text-gray-300">Next →</div>
                )}
            </nav>
        </div>
    );
        ...
        <>
            ...
            <div className="max-w-7xl mx-auto px-8 py-20">
                <div className="mb-16 text-center">
                    <h1 className="text-5xl md:text-5xl font-light tracking-tighter leading-none">
                        {title}
                    </h1>
                </div>
                <div className="flex flex-col md:flex-row gap-16">
                    ...
                    <div className="md:min-w-24 flex-shrink-0">
                        <div className="sticky top-24 px-3 md:px-8">
                            <div className="text-sm font-mono text-gray-500 mb-6">Topics</div>
                    ...
                    <div className="flex-1">
                        <div className="space-y-12 px-0 md:px-8">
